export const especies = [
  ...
  Es una palma cespitosa con hasta cien estípites erectos de 3 a 5 m de altura y 1,5 a 3 cm de diámetro, sus hojas están esparcidas a lo largo del tallo, la vaina de 30 a 60 cm de longitud tiene aguijones delgados de 1 cm de largo, el pecíolo de 4 a 7 cm tiene espinas de 3 a 6 cm, también presentes en el raquis, el cual mide 25 a 80 cm de longitud y tiene de 19 a 42 pinnas de 20 a 30 cm a cada lado, flores de 4 a 6 mm estaminadas y pistiladas, el soporte de la inflorescencia tiene hasta 20 cm de largo, con una bráctea amarillenta encima. Fruto en racimo, globoso deprimido, color negro violáceo, de 1,5 a 2 cm de diámetro.`,
      propiedades:`
  La madera de estas palmas se utiliza en la fabricación de diferentes objetos. De algunas de las especies de estos árboles del corozo, su madera es utilizada para la construcción de viviendas, y en otros aspectos relacionados con el hábitat; también a base de su madera se elaboran las conocidas flautas, que denomina flauta de millo, que se emplea como instrumento en la cumbia, las gaitas y otros géneros musicales.
  Los frutos aparecen en las copas de estas palmas que pueden tener hasta 3 o 5 metros de ancho;  se trata de una especie de fruta ciruela, arándano o incluso puede llegar a tener una apariencia similar al acai de fuerte tradición gastronómica desde la llegada de los esclavos africanos. `,
  ...
  La nuez del merey se puede hervir, asar o tostar y se come como bocadillo en muchas partes del mundo; también se muele para hacer mantequilla de nuez o se utilizan en distintos caramelos y otros dulces; en India y en Asia Sudoccidental, a menudo se incorpora merey en diversos platos de comida; la nuez es rica en proteínas y grasas. `,
    ...
    },
    {
      ...
      title: 'Moriche',
      publisher: 'Forestales',
      title_cientifico: 'MAURITIA FLEXUOSA',
      image: 'moriche.jpg',
      imageURL: 'https://upload.wikimedia.org/wikipedia/commons/2/23/Mauritia_flexuosa_%2819861732855%29.jpg',
      caracteristicas_fisicas: `
  Mauritia flexuosa es una especie de palmera perteneciente a la familia arecaceae, recibe los nombres comunes de palma de moriche o simplemente Moriche (en Bolivia, Colombia, Puerto Rico y Venezuela), Aguaje (en Perú), Burití (en Brasil), o Morete (en Ecuador).`,
      propiedades:`
  El tallo tierno se puede cortar para extraer palmitos comestibles, y de las hojas se extraen fibras para fabricar cordeles, cestas, chinchorros y otros objetos.`,
  ...
  La corteza tiene principios activos que mediante el cocimiento permite emplearlo para el tratamiento de los síntomas del paludismo. `,
    ...
    },
    {
      ...
      caracteristicas_fisicas: `
  Árbol que puede llegar a alcanzar los 35 metros de altura, de tallo engrosado y brillante, posee un grupo de ramas gruesas casi horizontales en la parte superior, sus flores son amarillentas o rojizas y de forma acampanada, sus frutos están rodeados por cinco alas membranosas de color rosa.`,
      propiedades:`
  Según la escala de janka es una de las maderas más blandas que existen con un valor de 22 unidades frente a las 5060 del roble-toro (australian buloke = allocasuarina luchmannii); o sea, es 23 veces más blanda. Con su madera se elaboran canoas, artesas, usadas estas últimas para guardar granos, harinas y para lavar; la semilla central del fruto se come tostada; en árboles jóvenes la fibra de su corteza se utiliza como jagua o amarre; en el darién panameño, la madera descompuesta del árbol se utiliza como abono de jardín; de otro lado, ramas y corteza de árboles muertos, se utiliza para alimentar cerdos. `,
    ...
    },
    {
      ...
      title: 'Ceiba',
      publisher: 'Forestales',
      title_cientifico: 'CEIBA PENTANDRA',
      image: 'ceiba.jpg',
  ...
  La madera de este árbol es blanca y blanda se utiliza en carpintería para empaques y cajas de madera. También se ha utilizado para fabricar canoas. La decocción de las hojas se utiliza para afecciones de la piel, granos y picaduras infectadas de insectos. De las semillas se obtienen aceite, el cual es utilizado para la elaboración de jabones y como combustible para lámparas de aceite. Igualmente de la lana que envuelve las semillas frutos se obtiene el kapok que sirve de relleno para la fabricación de almohadas antialérgicas, colchones, rellenos y aislantes térmicos para aparatos de refrigeración, por esta razón se cultivan en países tropicales asiáticos `,
    ...
    },
    {
      ...
      title: 'Bucare',
      publisher: 'Forestales',
      title_cientifico: 'ERYTHRINA POEPPIGIANA',
      image: 'bucare.jpg',
      imageURL: 'https://static.wixstatic.com/media/54c99b_7714aa8271664b71bfa88094acee3059.jpg',
      caracteristicas_fisicas: `
  ...
  `,
      propiedades:`
  Se utiliza para reforestaciones, para parques o grandes extensiones verdes, se destaca espléndidamente por el color de sus flores; también se usa en elaboración de cajonería, tableros aglomerados, para alimentación animal, como sombrío de cafetales y cacaotales y para protección de aguas; la madera es bastante liviana, aunque es poco durable por ser susceptible a la pudrición cuando está en contacto con el suelo. `,
    ...
    },
    {
      ...
      title: 'Jacaranda',
      publisher: 'Forestales',
      title_cientifico: 'JACARANDA MIMOSIFOLIA',
      image: 'jacaranda.jpg',

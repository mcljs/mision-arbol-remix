const navigation = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/fundamiarbolven/",
    icon: (props) => (
  ...
  {
    name: "Rss",
    href: "https://misionarbol.minec.gob.ve/posts/rss.xml",
    icon: (props) => (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" {...props} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >

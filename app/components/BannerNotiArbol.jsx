        ...
        <div className="lg:grid lg:grid-cols-12">
          ...
          <div className="relative bg-primary-900 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
            ...
            <div className="relative mx-auto max-w-md space-y-6 py-12 px-4 sm:max-w-3xl sm:py-16 sm:px-6 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
              <h2
                className="text-3xl font-bold tracking-tight text-[#03091e]"
                id="join-heading"
              >
              ...
              <p className="text-lg text-[#03091e]">
                Caracas &bull; 22 de Octubre de 2021
              </p>
              <Link
                className="block w-full rounded-md border border-transparent bg-[#121f3d] py-3 px-5 text-center text-base font-medium text-[#97ca3f] shadow-md  sm:inline-block sm:w-auto"

...
function NotiArbol() {
  return (
    <>
      <h2 className="text-center text-base font-semibold uppercase tracking-wider text-green-600">
        NOTIARBOL
      </h2>
        ...
        <div className="wrap">
          ...
          <article className="noticia-imagen noticia1 bg-gray-200 dark:bg-slate-900">
            ...
            <p className="mt-4 max-w-md px-8 text-left text-slate-900 dark:text-slate-100">
              En aras de profundizar la arquitectura financiera del Poder
              Popular, el presidente de la República, Nicolás Maduro, reiteró la
              necesidad de fortalecer los Bancos Comunales en cada comuna y
              consejo comunal del territorio nacional.
            </p>
            <footer className="mt-3 px-8">
              <button
                type="button"
                className="inline-flex items-center rounded-md border border-transparent  bg-[#98ca3f] px-4 py-2 text-base  font-medium text-[#03091e] shadow-sm  hover:bg-[#c1df8b] focus:outline-none focus:ring-2 focus:ring-offset-2"
              >
                Ver más
              </button>
            </footer>
          ...
          <article className="noticia-imagen2 noticia2 hidden bg-gray-200 dark:bg-slate-900 sm:table-cell lg:table-cell">
            <header>
              <div className="imgcont px-8">
                <div className="imgwrapper">
                  <img
